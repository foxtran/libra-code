...
void update_Mull_orb_pop(MATRIX *P, MATRIX *S,
  ...
  /**
    ...
    orbital-resolved Mulliken gross populations \param[in,out] Mull_orb_pop_net
    The vector which will collect orbital-resolved Mulliken net populations
  */
...
void update_Mull_charges(vector<int> &fragment, vector<int> &basis_fo,
  ...
  /**
    ...
    a-th atom of the fragment. \param[in]  basis_fo  Contains the global indices
    of the basis functions centered on the chosen (by the "fragment" variable)
    fragment \param[in] at_orbitals Mapping bewteen the local indices of the
    basis functions in the atom set and the global indices of all basis
    functions. For instance at_orbitals[n][i] is the global index of the i-th
    basis fucntion of n-th atoms. \param[in] Zeff Effective charges of all
    nuclei \param[in] Mull_orb_pop_gross Mulliken gross populations on all
    orbitals \param[in] Mull_orb_pop_net Mulliken net populations on all
    orbitals \param[out] Mull_charges_gross Mulliken gross charges on all atoms
...
void update_Mull_charges(vector<int> &ao_to_atom_map, vector<double> &Zeff,
  ...
  /**
    ...
    i-th AO is localized. \param[in] Zeff Effective charges of all nuclei
