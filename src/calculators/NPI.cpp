...
MATRIX nac_npi(MATRIX &St, double dt) {
  /**
   ...
   Meek, G.A; Levine, B. G. "Evaluation of the Time-Derivative Coupling for
   Accurate Electronic State Transition Probabilities from Numerical
   Simulations" J. Phys. Chem. Lett. 5, 2351-2356, 2014
