...
/**
  ...
  \brief The file implement functions for nuclear interaction energy/force
  calculations
...
double energy_nucl(vector<VECTOR> &R, vector<double> &Zeff, vector<VECTOR> &G) {
  /**
    ...
    Simple nuclear-nuclear Coulombic interaction. Derivatives w.r.t. all
    coordinates
  ...
  */
  ...
  for (int i = 0; i < sz; i++) {
    G.push_back(VECTOR(0.0, 0.0, 0.0));
  }
