...
void export_converters_objects() {
  ...
  void (*expt_system_to_nuclear_v1)(System & syst, Nuclear & nucl) =
      &system_to_nuclear;
  void (*expt_nuclear_to_system_v1)(Nuclear & nucl, System & syst) =
      &nuclear_to_system;
  ...
  //  vector<listHamiltonian_QM> (*expt_Py2Cpp_v7)(boost::python::list x) =
  //  &Py2Cpp;
  ...
  //  boost::python::list (*expt_Cpp2Py_v7)(vector<listHamiltonian_QM>& x) =
  //  &Cpp2Py;
  ...
  class_<StringList>("StringList").def(vector_indexing_suite<StringList>())
      ...
      //    .def("append", &std_item<StringList>::add,
      //    with_custodian_and_ward<1,2>()) // to let container keep value
      //    .def("__getitem__", &std_item<StringList>::get,
      //    return_value_policy<copy_non_const_reference>()) .def("__setitem__",
      //    &std_item<StringList>::set, with_custodian_and_ward<1,2>()) // to
      //    let container keep value .def("__delitem__",
      //    &std_item<StringList>::del) .def("index",
      //    &std_item<StringList>::index) .def("in", &std_item<StringList>::in)
      //    .def("__iter__", boost::python::iterator<StringList>())
      ;

  class_<StringMap>("StringMap").def(vector_indexing_suite<StringMap>());
  ...
  class_<StringDoubleMap>("StringDoubleMap")
      ...
      .def("__getitem__", &map_item<StringDoubleMap>::get,
           return_value_policy<copy_non_const_reference>())
      .def("__setitem__", &map_item<StringDoubleMap>::set,
           with_custodian_and_ward<1, 2>()) // to let container keep value
  ...
  class_<StringIntMap>("StringIntMap")
      ...
      .def("__getitem__", &map_item<StringIntMap>::get,
           return_value_policy<copy_non_const_reference>())
      .def("__setitem__", &map_item<StringIntMap>::set,
           with_custodian_and_ward<1, 2>()) // to let container keep value
  ...
  class_<StringVDoubleMap>("StringVDoubleMap")
      ...
      .def("__getitem__", &map_item<StringVDoubleMap>::get,
           return_value_policy<copy_non_const_reference>())
      .def("__setitem__", &map_item<StringVDoubleMap>::set,
           with_custodian_and_ward<1, 2>()) // to let container keep value
