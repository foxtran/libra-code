...
template <class T> vector<T> Py2Cpp(boost::python::list x) {
  /**
...
template <class T> boost::python::list Cpp2Py(vector<T> &x) {
  /**
...
template <class T> struct std_item {
...
template <class T> struct map_item {
...
template <class T> static boost::python::list keys(T const &x) {
  boost::python::list t;
...
template <class T> static boost::python::list values(T const &x) {
  boost::python::list t;
...
template <class T> static boost::python::list items(T const &x) {
  boost::python::list t;
  for (typename T::const_iterator it = x.begin(); it != x.end(); ++it) {
