...
void export_RigidBody_objects() {
  ...
  */
  ...
  int (RigidBody::*init2)(int sz, boost::python::list masses,
                          boost::python::list positions) = &RigidBody::init;

  int (RigidBody::*set_orientation1)(const MATRIX3x3 &) =
      &RigidBody::set_orientation;
  int (RigidBody::*set_orientation2)(const VECTOR &, const VECTOR &,
                                     const VECTOR &) =
      &RigidBody::set_orientation;
  int (RigidBody::*set_orientation3)(const QUATERNION &) =
      &RigidBody::set_orientation;
  int (RigidBody::*set_angular_momentum1)(const VECTOR &) =
      &RigidBody::set_angular_momentum;
  int (RigidBody::*set_angular_momentum2)(const double &, const double &,
                                          const double &) =
      &RigidBody::set_angular_momentum;
  int (RigidBody::*set_angular_velocity1)(const VECTOR &) =
      &RigidBody::set_angular_velocity;
  int (RigidBody::*set_angular_velocity2)(const double &, const double &,
                                          const double &) =
      &RigidBody::set_angular_velocity;
  int (RigidBody::*scale_angular_1)(double) = &RigidBody::scale_angular_;
  int (RigidBody::*scale_angular_2)(double, double, double) =
      &RigidBody::scale_angular_;
  int (RigidBody::*scale_angular_3)(const MATRIX3x3 &) =
      &RigidBody::scale_angular_;

  int (RigidBody::*scale_linear_1)(double) = &RigidBody::scale_linear_;
  int (RigidBody::*scale_linear_2)(double, double, double) =
      &RigidBody::scale_linear_;
  int (RigidBody::*scale_linear_3)(const MATRIX3x3 &) =
      &RigidBody::scale_linear_;
  int (RigidBody::*scale_position1)(double) = &RigidBody::scale_position;
  int (RigidBody::*scale_position2)(double, double, double) =
      &RigidBody::scale_position;
  int (RigidBody::*scale_position3)(const MATRIX3x3 &) =
      &RigidBody::scale_position;
  ...
  void (RigidBody::*Rotate2)(const MATRIX3x3 &rot, const VECTOR &pivot) =
      &RigidBody::Rotate;
  void (RigidBody::*Rotate3)(const QUATERNION &rot) = &RigidBody::Rotate;
  void (RigidBody::*Rotate4)(const QUATERNION &rot, const VECTOR &pivot) =
      &RigidBody::Rotate;
  void (RigidBody::*Rotate5)(double phi, const VECTOR &dir) =
      &RigidBody::Rotate;
  void (RigidBody::*Rotate6)(double phi, const VECTOR &dir,
                             const VECTOR &pivot) = &RigidBody::Rotate;

  void (RigidBody::*expt_Rotate_I_v1)(double, const VECTOR &dir) =
      &RigidBody::Rotate_I;

  void (RigidBody::*expt_propagate_dlml_v1)(double t, double &) =
      &RigidBody::propagate_dlml;
  double (RigidBody::*expt_propagate_dlml_v2)(double t) =
      &RigidBody::propagate_dlml;
  ...
  class_<RigidBody>("RigidBody", init<>())
      ...
      .def_readwrite("set_orientation_option",
                     &RigidBody::set_orientation_option)
      .def_readwrite("is_set_orientation_option",
                     &RigidBody::is_set_orientation_option)
      ...
      .def("get_Nf_t", &RigidBody::get_Nf_t,
           "returns the number of translational degrees of freedom for this RB")
      .def("get_Nf_r", &RigidBody::get_Nf_r,
           "returns the number of rotational degrees of freedom for this RB")
      ...
      .def("body_frame_to_lab_frame", &RigidBody::body_frame_to_lab_frame,
           "convert vector from body coordinate system to the lab(external) "
           "coordinate system")
      .def("lab_frame_to_body_frame", &RigidBody::lab_frame_to_body_frame)
      .def("ekin_rot", &RigidBody::ekin_rot,
           "returns rotational kinetic energy")
      .def("ekin_tr", &RigidBody::ekin_tr,
           "returns translational kinetic energy")
      .def("Rotate_I_x", &RigidBody::Rotate_I_x,
           "rotate arond x axis in global(Cartesian) coordinate system")
      .def("Rotate_I_y", &RigidBody::Rotate_I_y,
           "rotate arond y axis in global(Cartesian) coordinate system")
      .def("Rotate_I_z", &RigidBody::Rotate_I_z,
           "rotate arond z axis in global(Cartesian) coordinate system")
      .def("Rotate_e_x", &RigidBody::Rotate_e_x,
           "rotate arond x axis in rigid body coordinate system")
      .def("Rotate_e_y", &RigidBody::Rotate_e_y,
           "rotate arond y axis in rigid body coordinate system")
      .def("Rotate_e_z", &RigidBody::Rotate_e_z,
           "rotate arond z axis in rigid body coordinate system")
      .def("Rotate", Rotate1,
           "arbitrary rotation of RB, rotation is defined by the "
           "transformation matrix")
      .def("Rotate", Rotate2,
           "arbitrary rotation of RB, rotation is defined by the "
           "transformation matrix")
      .def("Rotate", Rotate3,
           "arbitrary rotation of RB, rotation is defined by the quaternion")
      .def("Rotate", Rotate4,
           "arbitrary rotation of RB, rotation is defined by the quaternion")
      .def("Rotate", Rotate5, "")
      .def("Rotate", Rotate6, "")
      ...
      .def("initialize_exact_rb", &RigidBody::initialize_exact_rb,
           "initialization of the R van Zon integrator")
      .def("propagate_exact_rb", &RigidBody::propagate_exact_rb,
           "exact solution for free RB problem, based on Jacoby method as "
           "discussed by R van Zon")
      .def("propagate_dlml", expt_propagate_dlml_v1,
           "DLML = Dullweber, Leimkuhler, McLachlan")
      .def("propagate_dlml", expt_propagate_dlml_v2,
           "DLML = Dullweber, Leimkuhler, McLachlan")

      .def("propagate_no_squish", &RigidBody::propagate_no_squish,
           "Symplectic quaternion scheme of Miller and co-workers")
      .def("initialize_terec", &RigidBody::initialize_terec,
           "inialization of the Terec integrator, see JCTC paper by Akimov & "
           "Kolomeisky")
      .def("propagate_terec", &RigidBody::propagate_terec,
           "Terec integrator with matrices, see JCTC paper by Akimov & "
           "Kolomeisky")
      .def("propagate_qterec", &RigidBody::propagate_qterec,
           "Terec integrator with quaternions, see JCTC paper by Akimov & "
           "Kolomeisky")
      .def("propagate_kln", &RigidBody::propagate_kln,
           "4-rotation integrator of Kamberaj, Low, Neal")
      .def("propagate_omelyan", &RigidBody::propagate_omelyan,
           "Omelyan RB integrator")
