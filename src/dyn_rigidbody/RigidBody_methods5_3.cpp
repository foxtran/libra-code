...
/**
  ...
  \brief The file implements the SQUISH propagation method based on quaternion
  rotations. This is a symplectic scheme.
...
void RigidBody::propagate_no_squish(double t) {
  /**
    ...
    Ikeguchi, M. Partial Rigid-Body Dynamics in NPT, NPAT and NP$\gamma$T
    Ensembles for Proteins and Membranes. J. Comput. Chem. 2004, 25 (4),
    529–541.
