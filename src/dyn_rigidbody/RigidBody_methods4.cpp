...
void RigidBody::Rotate(double phi, const VECTOR &dir, const VECTOR &pivot) {
  /**
    \brief Arbitrary rotation in the body frame, parameterized by a rotation
    axis, pivot point, and angle

    The rotation axis and angle define a quaternion, which is then applied to
    produce rotation
...
void RigidBody::Rotate(double phi, const VECTOR &dir) {
  /**
    \brief Arbitrary rotation in the body frame around the center of mass,
    parameterized by a rotation axis and angle
...
void RigidBody::Rotate_I(double phi, const VECTOR &lab_dir) {
  /**
    \brief Arbitrary rotation in the lab (external) frame, parameterized by a
