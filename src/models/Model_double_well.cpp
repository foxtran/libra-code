...
/**
  ...
  \brief The file implements the functions for computing the dobule_well
  Hamiltonian and its derivatives - model for tunneling between two symmetric
  potentials seperated by a barrier.
...
void double_well_Ham(double x, MATRIX *H, MATRIX *dH, MATRIX *d2H,
                     vector<double> &params) {
  /** The symmetric double well potential. Two local minima are located at x =
    -1.0 and 1.0. A local maximum is located at x = 0.
    ...
    written \param[in] Currently, 0 parameters are used for the double well
    potential. values will be used:

    Double well potential Hamiltonian and its derivatives in diabatic
    representation:
