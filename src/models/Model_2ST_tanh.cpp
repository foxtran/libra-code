...
/**
  ...
  \brief The file implements the 2-state tanh-barrier potentials (different
  nuclear dimensions)
*/
...
vector<double> set_params_2S_1D_tanh(std::string model) {
  ...
  */
  ...
  if (model == "TANH:Case1:JCP:2018:148:102326") {
    ...
    [Church, M. S.; Hele, T. J. H.; Ezra, G. S.; Ananth, N. Nonadiabatic
    Semiclassical Dynamics in the Mixed Quantum-Classical Initial Value
    Representation. The Journal of Chemical Physics 2018, 148, 102326]

    Similar setup is here:
    [Ananth, N.; Venkataraman, C.; Miller, W. H. Semiclassical Description of
    Electronically Nonadiabatic Dynamics via the Initial Value Representation.
    The Journal of Chemical Physics 2007, 127, 084114.]
    */
    params[0] = 0.01;
    params[1] = 1.6; // H00
    params[2] = 0.01;
...
void model_2S_1D_tanh(CMATRIX &Hdia, CMATRIX &Sdia, vector<CMATRIX> &d1ham_dia,
  ...
  /***
    ...
    \param[in] params The model parameters: up to 7 parameters (see the chart
