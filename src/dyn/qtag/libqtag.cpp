...
void export_qtag_objects() {
  ...
  */
  ...
  (MATRIX & q, MATRIX & q1, MATRIX & p1, MATRIX & alp1, MATRIX & s1,
   CMATRIX & Coeff) = &qtag_psi;
...
/*
  ...
  (MATRIX & q1, MATRIX & p1, MATRIX & s1, MATRIX & alp1, int n1,
   vector<int> &traj_on_surf_n1, MATRIX &q2, MATRIX &p2, MATRIX &s2,
   MATRIX &alp2, int n2, vector<int> &traj_on_surf_n2, nHamiltonian &ham,
   int method, double AA, double BB, double CC) = &qtag_potential;
...
*/
  void (*expt_qtag_hamiltonian_and_overlap_v1)(
      ...
      vector<int> & active_states, MATRIX & invM, nHamiltonian & ham,
      bp::object compute_ham_funct, bp::dict compute_ham_params,
      bp::dict & dyn_params, CMATRIX & super_ovlp, CMATRIX & super_ham) =
