...
template <typename T1> void export_base_matrix() {

  void (base_matrix<T1>::*expt_set_v1)(int i, T1 val) = &base_matrix<T1>::set;
  void (base_matrix<T1>::*expt_set_v2)(int i, int j, T1 val) =
      &base_matrix<T1>::set;
  ...
  void (base_matrix<T1>::*expt_add_v1)(int row, int col, T1 x) =
      &base_matrix<T1>::add;
  //  void (base_matrix<T1>::*expt_add_v1)(int row,int col, int x) =
  //  &base_matrix<T1>::add; void (base_matrix<T1>::*expt_add_v2)(int row,int
  //  col, double x) = &base_matrix<T1>::add;
  void (base_matrix<T1>::*expt_scale_v1)(int row, int col, T1 x) =
      &base_matrix<T1>::scale;
  //  void (base_matrix<T1>::*expt_scale_v1)(int row,int col, int x) =
  //  &base_matrix<T1>::scale; void (base_matrix<T1>::*expt_scale_v2)(int
  //  row,int col, double x) = &base_matrix<T1>::scale;

  T1 (base_matrix<T1>::*expt_sum_col_v1)(int icol) = &base_matrix<T1>::sum_col;
  T1 (base_matrix<T1>::*expt_sum_col_v2)
  (int icol, int power) = &base_matrix<T1>::sum_col;
  T1 (base_matrix<T1>::*expt_sum_row_v1)(int irow) = &base_matrix<T1>::sum_row;
  T1 (base_matrix<T1>::*expt_sum_row_v2)
  (int irow, int power) = &base_matrix<T1>::sum_row;

  T1 (base_matrix<T1>::*expt_prod_col_v1)
  (int icol) = &base_matrix<T1>::prod_col;
  T1 (base_matrix<T1>::*expt_prod_row_v1)
  (int irow) = &base_matrix<T1>::prod_row;

  void (base_matrix<T1>::*expt_show_matrix_v1)() =
      &base_matrix<T1>::show_matrix;
  void (base_matrix<T1>::*expt_show_matrix_v2)(char *Output_File) =
      &base_matrix<T1>::show_matrix;

  // Also expose some functions
  void (*expt_pop_submatrix_v1)(base_matrix<T1> & X, base_matrix<T1> & x,
                                vector<int> & subset) = &pop_submatrix;
  void (*expt_pop_submatrix_v2)(base_matrix<T1> & X, base_matrix<T1> & x,
                                boost::python::list subset) = &pop_submatrix;
  void (*expt_pop_submatrix_v3)(base_matrix<T1> & X, base_matrix<T1> & x,
                                vector<int> & subset, vector<int> & subset2) =
      &pop_submatrix;
  void (*expt_pop_submatrix_v4)(base_matrix<T1> & X, base_matrix<T1> & x,
                                boost::python::list subset,
                                boost::python::list subset2) = &pop_submatrix;

  void (*expt_push_submatrix_v1)(base_matrix<T1> & X, base_matrix<T1> & x,
                                 vector<int> & subset) = &push_submatrix;
  void (*expt_push_submatrix_v2)(base_matrix<T1> & X, base_matrix<T1> & x,
                                 boost::python::list subset) = &push_submatrix;
  void (*expt_push_submatrix_v3)(base_matrix<T1> & X, base_matrix<T1> & x,
                                 vector<int> & subset, vector<int> & subset2) =
      &push_submatrix;
  void (*expt_push_submatrix_v4)(base_matrix<T1> & X, base_matrix<T1> & x,
                                 boost::python::list subset,
                                 boost::python::list subset2) = &push_submatrix;

  void (*expt_add_submatrix_v1)(base_matrix<T1> & X, base_matrix<T1> & x,
                                vector<int> & subset, T1 alpha) =
      &add_submatrix;
  void (*expt_add_submatrix_v2)(base_matrix<T1> & X, base_matrix<T1> & x,
                                boost::python::list subset, T1 alpha) =
      &add_submatrix;
  void (*expt_add_submatrix_v3)(base_matrix<T1> & X, base_matrix<T1> & x,
                                vector<int> & subset, vector<int> & subset2,
                                T1 alpha) = &add_submatrix;
  void (*expt_add_submatrix_v4)(
      base_matrix<T1> & X, base_matrix<T1> & x, boost::python::list subset,
      boost::python::list subset2, T1 alpha) = &add_submatrix;
...
void export_IMATRIX() {
  ...
  void (IMATRIX::*expt_max_col_elt_v1)(int, int &, int &) =
      &IMATRIX::max_col_elt;
  boost::python::list (IMATRIX::*expt_max_col_elt_v2)(int) =
      &IMATRIX::max_col_elt;

  void (IMATRIX::*expt_min_col_elt_v1)(int, int &, int &) =
      &IMATRIX::min_col_elt;
  boost::python::list (IMATRIX::*expt_min_col_elt_v2)(int) =
      &IMATRIX::min_col_elt;

  void (IMATRIX::*expt_max_row_elt_v1)(int, int &, int &) =
      &IMATRIX::max_row_elt;
  boost::python::list (IMATRIX::*expt_max_row_elt_v2)(int) =
      &IMATRIX::max_row_elt;

  void (IMATRIX::*expt_min_row_elt_v1)(int, int &, int &) =
      &IMATRIX::min_row_elt;
  boost::python::list (IMATRIX::*expt_min_row_elt_v2)(int) =
      &IMATRIX::min_row_elt;
  ...
  */
  ...
  class_<IMATRIXList>("IMATRIXList").def(vector_indexing_suite<IMATRIXList>());

  class_<IMATRIXMap>("IMATRIXMap").def(vector_indexing_suite<IMATRIXMap>());
}
  ...
  */
  ...
  static boost::python::tuple getstate(const MATRIX &w) {
    ...
    for (int i = 0; i < w.n_elts; i++) {
      res = boost::python::extract<boost::python::tuple>(
          res + boost::python::make_tuple(w.get(i)));
    } // for i
...
void export_MATRIX() {
  ...
  // It is important to wrap the base class - or the derived class wrapping
  // won't work unfortunately, it seems like we need to do this for every data
  // type
  export_base_matrix<double>();

  void (MATRIX::*expt_init_v1)(const VECTOR &u1, const VECTOR &u2,
                               const VECTOR &u3) = &MATRIX::init;

  void (MATRIX::*expt_max_col_elt_v1)(int I, double &val, int &max_elt_indx) =
      &MATRIX::max_col_elt;
  boost::python::list (MATRIX::*expt_max_col_elt_v2)(int I) =
      &MATRIX::max_col_elt;
  void (MATRIX::*expt_min_col_elt_v1)(int I, double &val, int &max_elt_indx) =
      &MATRIX::min_col_elt;
  boost::python::list (MATRIX::*expt_min_col_elt_v2)(int I) =
      &MATRIX::min_col_elt;

  void (MATRIX::*expt_max_row_elt_v1)(int I, double &val, int &max_elt_indx) =
      &MATRIX::max_row_elt;
  boost::python::list (MATRIX::*expt_max_row_elt_v2)(int I) =
      &MATRIX::max_row_elt;
  void (MATRIX::*expt_min_row_elt_v1)(int I, double &val, int &max_elt_indx) =
      &MATRIX::min_row_elt;
  boost::python::list (MATRIX::*expt_min_row_elt_v2)(int I) =
      &MATRIX::min_row_elt;
  ...
  struct MATRIXList_pickle_suite : boost::python::pickle_suite {
    ...
    */
    ...
    static boost::python::tuple getstate(const MATRIXList &w) {
      ...
      for (int i = 0; i < sz; i++) {
        res = boost::python::extract<boost::python::tuple>(
            res + boost::python::make_tuple(w[i]));
      } // for i
  ...
  class_<MATRIXMap>("MATRIXMap").def(vector_indexing_suite<MATRIXMap>());
}
...
void export_CMATRIX() {
  ...
  void (CMATRIX::*expt_cmax_col_elt_v1)(int, complex<double> &, int &) =
      &CMATRIX::max_col_elt;
  boost::python::list (CMATRIX::*expt_cmax_col_elt_v2)(int) =
      &CMATRIX::max_col_elt;

  void (CMATRIX::*expt_cmin_col_elt_v1)(int, complex<double> &, int &) =
      &CMATRIX::min_col_elt;
  boost::python::list (CMATRIX::*expt_cmin_col_elt_v2)(int) =
      &CMATRIX::min_col_elt;

  void (CMATRIX::*expt_cmax_row_elt_v1)(int, complex<double> &, int &) =
      &CMATRIX::max_row_elt;
  boost::python::list (CMATRIX::*expt_cmax_row_elt_v2)(int) =
      &CMATRIX::max_row_elt;

  void (CMATRIX::*expt_cmin_row_elt_v1)(int, complex<double> &, int &) =
      &CMATRIX::min_row_elt;
  boost::python::list (CMATRIX::*expt_cmin_row_elt_v2)(int) =
      &CMATRIX::min_row_elt;
  ...
  class_<CMATRIX, boost::python::bases<base_matrix<complex<double>>>>("CMATRIX",
                                                                      init<>())
      .def(init<int, int>())
      .def(init<MATRIX &>())
  ...
  class_<CMATRIXMap>("CMATRIXMap").def(vector_indexing_suite<CMATRIXMap>());
}

void export_VECTOR() {

  void (VECTOR::*expt_cross_v1)(const VECTOR &v1, const VECTOR &v2) =
      &VECTOR::cross;
  ...
  VECTOR (*expt_cross_v2)
  (const double k, const VECTOR &v1, const VECTOR &v2) = &cross;

  def("cross", expt_cross_v2);

  class_<VECTORList>("VECTORList").def(vector_indexing_suite<VECTORList>());

  class_<VECTORMap>("VECTORMap").def(vector_indexing_suite<VECTORMap>());
}

void export_MATRIX3x3() {

  void (MATRIX3x3::*expt_eigen_v1)(MATRIX3x3 &, MATRIX3x3 &) =
      &MATRIX3x3::eigen;
  void (MATRIX3x3::*expt_eigen_v2)(MATRIX3x3 &, MATRIX3x3 &, double) =
      &MATRIX3x3::eigen;

  void (MATRIX3x3::*expt_diag_v1)(double x) = &MATRIX3x3::diag;
  void (MATRIX3x3::*expt_diag_v2)(double x, double y, double z) =
      &MATRIX3x3::diag;
...
void export_FT() {
  ...
  void (*expt_cft_v1)(CMATRIX & in, CMATRIX & out, double xmin, double dx) =
      &cft;
  void (*expt_inv_cft_v1)(CMATRIX & in, CMATRIX & out, double xmin, double dx) =
      &inv_cft;

  void (*expt_cft1_v1)(CMATRIX & in, CMATRIX & out, double xmin, double kmin,
                       double dx) = &cft1;
  void (*expt_inv_cft1_v1)(CMATRIX & in, CMATRIX & out, double xmin,
                           double kmin, double dx) = &inv_cft1;

  //  The functions below are commented because the inv_CFT[ CFT ] is not the
  //  identity, perhaps because dk would need to satisfy some additional
  //  conditions void (*expt_cft2_v1)(CMATRIX& in,CMATRIX& out,double
  //  xmin,double kmin,double dx,double dk) = &cft2; void
  //  (*expt_inv_cft2_v1)(CMATRIX& in,CMATRIX& out,double xmin,double
  //  kmin,double dx,double dk) = &inv_cft2;
  ...
  //  The function below are commented because the inv_CFT[ CFT ] is not the
  //  identity, perhaps because dk would need to satisfy some additional
  //  conditions def("cft", expt_cft2_v1); def("inv_cft", expt_inv_cft2_v1);

  void (*expt_cft1_2D_v1)(CMATRIX & in, CMATRIX & out, double xmin, double ymin,
                          double kxmin, double kymin, double dx, double dy) =
      &cft1_2D;
  void (*expt_inv_cft1_2D_v1)(CMATRIX & in, CMATRIX & out, double xmin,
                              double ymin, double kxmin, double kymin,
                              double dx, double dy) = &inv_cft1_2D;

  def("cft_2D", expt_cft1_2D_v1);
  def("inv_cft_2D", expt_inv_cft1_2D_v1);

  void (*expt_convolve_v1)(CMATRIX & f, CMATRIX & g, CMATRIX & conv,
                           double dx) = &convolve;
  void (*expt_convolve_2D_v1)(CMATRIX & f, CMATRIX & g, CMATRIX & conv,
                              double dx, double dy) = &convolve_2D;

  def("convolve", expt_convolve_v1);
  def("convolve_2D", expt_convolve_2D_v1);

  //-------- Fast Fourier Transforms -------------
  void (*expt_cfft1_v1)(CMATRIX & in, CMATRIX & out, double xmin, double kmin,
                        double dx) = &cfft1;
  void (*expt_inv_cfft1_v1)(CMATRIX & in, CMATRIX & out, double xmin,
                            double kmin, double dx) = &inv_cfft1;
  def("cfft", expt_cfft1_v1);
  def("inv_cfft", expt_inv_cfft1_v1);

  void (*expt_cfft1_2D_v1)(CMATRIX & in, CMATRIX & out, double xmin,
                           double ymin, double kxmin, double kymin, double dx,
                           double dy) = &cfft1_2D;
  void (*expt_inv_cfft1_2D_v1)(CMATRIX & in, CMATRIX & out, double xmin,
                               double ymin, double kxmin, double kymin,
                               double dx, double dy) = &inv_cfft1_2D;
...
void export_permutations() {
  ...
  vector<int> (*expt_inverse_permutation_v1)(vector<int> & perm) =
      &inverse_permutation;
  def("inverse_permutation", expt_inverse_permutation_v1);

  vector<int> (*expt_composite_permutation_v1)(
      vector<int> & perm_t, vector<int> & perm_cum) = &composite_permutation;
  def("composite_permutation", expt_composite_permutation_v1);

  void (*expt_update_permutation_v1)(
      vector<int> & perm_t, vector<int> & perm_cum) = &update_permutation;
  def("update_permutation", expt_update_permutation_v1);

  void (*expt_check_permutation_v1)(vector<int> & perm, int n) =
      &check_permutation;
...
void export_linalg_objects() {
  ...
  */
  ...
  class_<floatList>("floatList").def(vector_indexing_suite<floatList>());

  class_<doubleList>("doubleList").def(vector_indexing_suite<doubleList>());

  class_<complexList>("complexList").def(vector_indexing_suite<complexList>());

  ///============== 2D data ======================

  class_<intList2>("intList2").def(vector_indexing_suite<intList2>());

  class_<floatList2>("floatList2").def(vector_indexing_suite<floatList2>());

  class_<doubleList2>("doubleList2").def(vector_indexing_suite<doubleList2>());
  ...
  class_<intList3>("intList3").def(vector_indexing_suite<intList3>());

  class_<floatList3>("floatList3").def(vector_indexing_suite<floatList3>());

  class_<doubleList3>("doubleList3").def(vector_indexing_suite<doubleList3>());

  class_<complexList3>("complexList3")
      .def(vector_indexing_suite<complexList3>());

  class_<intMap>("intMap").def(vector_indexing_suite<intMap>());

  class_<floatMap>("floatMap").def(vector_indexing_suite<floatMap>());

  class_<doubleMap>("doubleMap").def(vector_indexing_suite<doubleMap>());

  class_<complexMap>("complexMap").def(vector_indexing_suite<complexMap>());
  ...
  void (*expt_MATRIX_TO_QUATERNION_v1)(MATRIX &, QUATERNION &) =
      &MATRIX_TO_QUATERNION;
  void (*expt_MATRIX_TO_QUATERNION_v2)(MATRIX3x3 &, QUATERNION &) =
      &MATRIX_TO_QUATERNION;

  void (*expt_QUATERNION_TO_MATRIX_v1)(QUATERNION &, MATRIX &) =
      &QUATERNION_TO_MATRIX;
  void (*expt_QUATERNION_TO_MATRIX_v2)(QUATERNION &, MATRIX3x3 &) =
      &QUATERNION_TO_MATRIX;
