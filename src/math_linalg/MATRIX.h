...
/**
  \file MATRIX.h
  \brief The file describes the MATRIX class for representing arbitrary
  real-valued matrices

  ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

  NOTE:  the functions that return MATRIX should not be relpaced by the base
  template functions
...
public:
  ...
  */
  ...
  MATRIX
  operator-(const MATRIX &rhs); ///< Subtraction operator by a matrix type
...
typedef std::vector<MATRIX>
    MATRIXList; ///< Data type for storing a vector of MATRIX objects
typedef std::vector<vector<MATRIX>>
    MATRIXMap; ///< Data type for storing a table (grid) of MATRIX objects

//-------- IO functions --------
void set_value(int &defined, MATRIX &value, boost::python::object obj,
               std::string attrName);
