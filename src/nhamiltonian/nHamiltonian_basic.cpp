...
void nHamiltonian::show_memory_status(vector<int> &id_) {
  ...
  if (id_.size() == 1) {
    ...
    if (id_[0] == id) {
      ...
      for (n = 0; n < dc1_dia_mem_status.size(); n++) {
      ...
      for (n = 0; n < d1ham_dia_mem_status.size(); n++) {
        cout << d1ham_dia_mem_status[n] << " ";
      }
      cout << endl;
      cout << "d2ham_dia_mem_status = ";
      for (n = 0; n < d2ham_dia_mem_status.size(); n++) {
        cout << d2ham_dia_mem_status[n] << " ";
      }
      cout << endl;
      cout << "dc1_adi_mem_status = ";
      for (n = 0; n < dc1_adi_mem_status.size(); n++) {
      ...
      for (n = 0; n < d1ham_adi_mem_status.size(); n++) {
        cout << d1ham_adi_mem_status[n] << " ";
      }
      cout << endl;
      cout << "d2ham_adi_mem_status = ";
      for (n = 0; n < d2ham_adi_mem_status.size(); n++) {
...
void nHamiltonian::copy_content(const nHamiltonian &src) { copy_content(src); }
...
void nHamiltonian::copy_level_content(nHamiltonian *src) {
  ...
  */
  ...
  if (time_overlap_dia_mem_status != 0 &&
    ...
    *time_overlap_adi = *(src->time_overlap_dia);
  }
