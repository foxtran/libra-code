...
void export_nhamiltonian_objects() {
  ...
  */
  ...
  //  void (Hamiltonian::*set_params)(boost::python::list) =
  //  &Hamiltonian::set_params;

  CMATRIX (nHamiltonian::*expt_get_ovlp_dia_v1)() = &nHamiltonian::get_ovlp_dia;
  CMATRIX (nHamiltonian::*expt_get_ovlp_dia_v2)
  (vector<int> &) = &nHamiltonian::get_ovlp_dia;

  CMATRIX (nHamiltonian::*expt_get_dc1_dia_v1)
  (int i) = &nHamiltonian::get_dc1_dia;
  CMATRIX (nHamiltonian::*expt_get_dc1_dia_v2)
  (int i, vector<int> &) = &nHamiltonian::get_dc1_dia;

  CMATRIX (nHamiltonian::*expt_get_ham_dia_v1)() = &nHamiltonian::get_ham_dia;
  CMATRIX (nHamiltonian::*expt_get_ham_dia_v2)
  (vector<int> &) = &nHamiltonian::get_ham_dia;

  CMATRIX (nHamiltonian::*expt_get_nac_dia_v1)() = &nHamiltonian::get_nac_dia;
  CMATRIX (nHamiltonian::*expt_get_nac_dia_v2)
  (vector<int> &) = &nHamiltonian::get_nac_dia;

  CMATRIX (nHamiltonian::*expt_get_hvib_dia_v1)() = &nHamiltonian::get_hvib_dia;
  CMATRIX (nHamiltonian::*expt_get_hvib_dia_v2)
  (vector<int> &) = &nHamiltonian::get_hvib_dia;

  CMATRIX (nHamiltonian::*expt_get_d1ham_dia_v1)
  (int i) = &nHamiltonian::get_d1ham_dia;
  CMATRIX (nHamiltonian::*expt_get_d1ham_dia_v2)
  (int i, vector<int> &) = &nHamiltonian::get_d1ham_dia;

  CMATRIX (nHamiltonian::*expt_get_d2ham_dia_v11)
  (int i) = &nHamiltonian::get_d2ham_dia;
  CMATRIX (nHamiltonian::*expt_get_d2ham_dia_v12)
  (int i, vector<int> &) = &nHamiltonian::get_d2ham_dia;

  CMATRIX (nHamiltonian::*expt_get_d2ham_dia_v21)
  (int i, int j) = &nHamiltonian::get_d2ham_dia;
  CMATRIX (nHamiltonian::*expt_get_d2ham_dia_v22)
  (int i, int j, vector<int> &) = &nHamiltonian::get_d2ham_dia;

  CMATRIX (nHamiltonian::*expt_get_dc1_adi_v1)
  (int i) = &nHamiltonian::get_dc1_adi;
  CMATRIX (nHamiltonian::*expt_get_dc1_adi_v2)
  (int i, vector<int> &) = &nHamiltonian::get_dc1_adi;

  CMATRIX (nHamiltonian::*expt_get_ham_adi_v1)() = &nHamiltonian::get_ham_adi;
  CMATRIX (nHamiltonian::*expt_get_ham_adi_v2)
  (vector<int> &) = &nHamiltonian::get_ham_adi;

  CMATRIX (nHamiltonian::*expt_get_nac_adi_v1)() = &nHamiltonian::get_nac_adi;
  CMATRIX (nHamiltonian::*expt_get_nac_adi_v2)
  (vector<int> &) = &nHamiltonian::get_nac_adi;

  CMATRIX (nHamiltonian::*expt_get_hvib_adi_v1)() = &nHamiltonian::get_hvib_adi;
  CMATRIX (nHamiltonian::*expt_get_hvib_adi_v2)
  (vector<int> &) = &nHamiltonian::get_hvib_adi;

  CMATRIX (nHamiltonian::*expt_get_d1ham_adi_v1)
  (int i) = &nHamiltonian::get_d1ham_adi;
  CMATRIX (nHamiltonian::*expt_get_d1ham_adi_v2)
  (int i, vector<int> &) = &nHamiltonian::get_d1ham_adi;

  CMATRIX (nHamiltonian::*expt_get_d2ham_adi_v11)
  (int i) = &nHamiltonian::get_d2ham_adi;
  CMATRIX (nHamiltonian::*expt_get_d2ham_adi_v12)
  (int i, vector<int> &) = &nHamiltonian::get_d2ham_adi;

  CMATRIX (nHamiltonian::*expt_get_d2ham_adi_v21)
  (int i, int j) = &nHamiltonian::get_d2ham_adi;
  CMATRIX (nHamiltonian::*expt_get_d2ham_adi_v22)
  (int i, int j, vector<int> &) = &nHamiltonian::get_d2ham_adi;

  CMATRIX (nHamiltonian::*expt_get_basis_transform_v1)
  () = &nHamiltonian::get_basis_transform;
  CMATRIX (nHamiltonian::*expt_get_basis_transform_v2)
  (vector<int> &) = &nHamiltonian::get_basis_transform;

  CMATRIX (nHamiltonian::*expt_get_time_overlap_adi_v1)
  () = &nHamiltonian::get_time_overlap_adi;
  CMATRIX (nHamiltonian::*expt_get_time_overlap_adi_v2)
  (vector<int> &) = &nHamiltonian::get_time_overlap_adi;

  CMATRIX (nHamiltonian::*expt_get_time_overlap_dia_v1)
  () = &nHamiltonian::get_time_overlap_dia;
  CMATRIX (nHamiltonian::*expt_get_time_overlap_dia_v2)
  (vector<int> &) = &nHamiltonian::get_time_overlap_dia;

  vector<int> (nHamiltonian::*expt_get_ordering_adi_v1)() =
      &nHamiltonian::get_ordering_adi;
  vector<int> (nHamiltonian::*expt_get_ordering_adi_v2)(vector<int> &) =
      &nHamiltonian::get_ordering_adi;

  CMATRIX (nHamiltonian::*expt_get_cum_phase_corr_v1)
  () = &nHamiltonian::get_cum_phase_corr;
  CMATRIX (nHamiltonian::*expt_get_cum_phase_corr_v2)
  (vector<int> &) = &nHamiltonian::get_cum_phase_corr;

  // for internal model types
  void (nHamiltonian::*expt_compute_diabatic_v1)(
      int model, vector<double> &q, vector<double> &params, int lvl) =
      &nHamiltonian::compute_diabatic;

  void (nHamiltonian::*expt_compute_diabatic_v2)(int model, vector<double> &q,
                                                 vector<double> &params) =
      &nHamiltonian::compute_diabatic;

  // for models defined in Python
  /*
    void (nHamiltonian::*expt_compute_diabatic_v3)(bp::object py_funct,
    bp::object q, bp::object params, int lvl) = &nHamiltonian::compute_diabatic;

    void (nHamiltonian::*expt_compute_diabatic_v4)(bp::object py_funct,
    bp::object q, bp::object params) = &nHamiltonian::compute_diabatic;
  */
  void (nHamiltonian::*expt_compute_diabatic_v3)(
      bp::object py_funct, MATRIX & q, bp::object params, int lvl) =
      &nHamiltonian::compute_diabatic;

  void (nHamiltonian::*expt_compute_diabatic_v4)(
      bp::object py_funct, MATRIX & q, bp::object params) =
      &nHamiltonian::compute_diabatic;

  void (nHamiltonian::*expt_update_ordering_v1)(vector<int> & perm_t, int lvl) =
      &nHamiltonian::update_ordering;
  void (nHamiltonian::*expt_update_ordering_v2)(vector<int> & perm_t) =
      &nHamiltonian::update_ordering;
  /*
    void (nHamiltonian::*expt_apply_phase_corrections_v1)(CMATRIX& phase_corr,
    int lvl) = &nHamiltonian::apply_phase_corrections; void
    (nHamiltonian::*expt_apply_phase_corrections_v2)(CMATRIX& phase_corr) =
    &nHamiltonian::apply_phase_corrections;

    CMATRIX (nHamiltonian::*expt_update_phases_v1)(CMATRIX& phases, int lvl) =
    &nHamiltonian::update_phases; CMATRIX
    (nHamiltonian::*expt_update_phases_v2)(CMATRIX& phases) =
    &nHamiltonian::update_phases;
  */
  ...
  void (nHamiltonian::*expt_compute_adiabatic_v2)(int der_lvl) =
      &nHamiltonian::compute_adiabatic;
  void (nHamiltonian::*expt_compute_adiabatic_v3)(
      bp::object py_funct, MATRIX & q, bp::object params, int lvl) =
      &nHamiltonian::compute_adiabatic;
  void (nHamiltonian::*expt_compute_adiabatic_v4)(
      bp::object py_funct, MATRIX & q, bp::object params) =
      &nHamiltonian::compute_adiabatic;

  /*
    void (nHamiltonian::*expt_compute_adiabatic_v3)(bp::object py_funct,
    bp::object q, bp::object params, int lvl) =
    &nHamiltonian::compute_adiabatic; void
    (nHamiltonian::*expt_compute_adiabatic_v4)(bp::object py_funct, bp::object
    q, bp::object params) = &nHamiltonian::compute_adiabatic;
  */

  void (nHamiltonian::*expt_ampl_dia2adi_v1)(
      CMATRIX & ampl_dia, CMATRIX & ampl_adi) = &nHamiltonian::ampl_dia2adi;
  void (nHamiltonian::*expt_ampl_dia2adi_v2)(
      CMATRIX & ampl_dia, CMATRIX & ampl_adi, vector<int> & id_) =
      &nHamiltonian::ampl_dia2adi;
  void (nHamiltonian::*expt_ampl_dia2adi_v3)(
      CMATRIX & ampl_dia, CMATRIX & ampl_adi, int lvl, int split) =
      &nHamiltonian::ampl_dia2adi;
  void (nHamiltonian::*expt_ampl_adi2dia_v1)(
      CMATRIX & ampl_dia, CMATRIX & ampl_adi) = &nHamiltonian::ampl_adi2dia;
  void (nHamiltonian::*expt_ampl_adi2dia_v2)(
      CMATRIX & ampl_dia, CMATRIX & ampl_adi, vector<int> & id_) =
      &nHamiltonian::ampl_adi2dia;
  void (nHamiltonian::*expt_ampl_adi2dia_v3)(
      CMATRIX & ampl_dia, CMATRIX & ampl_adi, int lvl, int split) =
      &nHamiltonian::ampl_adi2dia;

  void (nHamiltonian::*expt_compute_nac_dia_v1)(
      MATRIX & p, const MATRIX &invM) = &nHamiltonian::compute_nac_dia;
  void (nHamiltonian::*expt_compute_nac_dia_v2)(MATRIX & p, const MATRIX &invM,
                                                vector<int> &id_) =
      &nHamiltonian::compute_nac_dia;
  void (nHamiltonian::*expt_compute_nac_dia_v3)(MATRIX & p, const MATRIX &invM,
                                                int lvl, int split) =
      &nHamiltonian::compute_nac_dia;
  void (nHamiltonian::*expt_compute_nac_adi_v1)(
      MATRIX & p, const MATRIX &invM) = &nHamiltonian::compute_nac_adi;
  void (nHamiltonian::*expt_compute_nac_adi_v2)(MATRIX & p, const MATRIX &invM,
                                                vector<int> &id_) =
      &nHamiltonian::compute_nac_adi;
  void (nHamiltonian::*expt_compute_nac_adi_v3)(MATRIX & p, const MATRIX &invM,
                                                int lvl, int split) =
      &nHamiltonian::compute_nac_adi;
  ...
  CMATRIX (nHamiltonian::*expt_forces_adi_v1)
  (vector<int> & act_states) = &nHamiltonian::forces_adi;

  CMATRIX (nHamiltonian::*expt_forces_dia_v1)
  (vector<int> & act_states) = &nHamiltonian::forces_dia;

  CMATRIX (nHamiltonian::*expt_all_forces_adi_v1)
  (vector<int> & id_) = &nHamiltonian::all_forces_adi;

  /*
    CMATRIX (nHamiltonian::*expt_forces_adi_v1)(CMATRIX& ampl_adi)
    = &nHamiltonian::forces_adi;
    CMATRIX (nHamiltonian::*expt_forces_adi_v2)(CMATRIX& ampl_adi, vector<int>&
    id_) = &nHamiltonian::forces_adi; CMATRIX
    (nHamiltonian::*expt_forces_adi_v3)(vector<int>& act_states) =
    &nHamiltonian::forces_adi; CMATRIX (nHamiltonian::*expt_forces_adi_v4)(int
    act_state) = &nHamiltonian::forces_adi;


    CMATRIX (nHamiltonian::*expt_forces_dia_v1)(CMATRIX& ampl_dia)
    = &nHamiltonian::forces_dia;
    CMATRIX (nHamiltonian::*expt_forces_dia_v2)(CMATRIX& ampl_dia, vector<int>&
    id_) = &nHamiltonian::forces_dia; CMATRIX
    (nHamiltonian::*expt_forces_dia_v3)(vector<int>& act_states) =
    &nHamiltonian::forces_dia; CMATRIX (nHamiltonian::*expt_forces_dia_v4)(int
    act_state) = &nHamiltonian::forces_dia;


    vector<CMATRIX> (nHamiltonian::*expt_forces_tens_adi_v1)(CMATRIX& ampl_adi)
    = &nHamiltonian::forces_tens_adi;
    vector<CMATRIX> (nHamiltonian::*expt_forces_tens_adi_v2)(CMATRIX& ampl_adi,
    vector<int>& id_) = &nHamiltonian::forces_tens_adi; vector<CMATRIX>
    (nHamiltonian::*expt_forces_tens_dia_v1)(CMATRIX& ampl_dia) =
    &nHamiltonian::forces_tens_dia; vector<CMATRIX>
    (nHamiltonian::*expt_forces_tens_dia_v2)(CMATRIX& ampl_dia, vector<int>&
    id_) = &nHamiltonian::forces_tens_dia;

  */

  complex<double> (nHamiltonian::*expt_Ehrenfest_energy_adi_v1)(
      CMATRIX & ampl_adi) = &nHamiltonian::Ehrenfest_energy_adi;
  complex<double> (nHamiltonian::*expt_Ehrenfest_energy_adi_v2)(
      CMATRIX & ampl_adi, vector<int> & id_) =
      &nHamiltonian::Ehrenfest_energy_adi;
  complex<double> (nHamiltonian::*expt_Ehrenfest_energy_dia_v1)(
      CMATRIX & ampl_dia) = &nHamiltonian::Ehrenfest_energy_dia;
  complex<double> (nHamiltonian::*expt_Ehrenfest_energy_dia_v2)(
      CMATRIX & ampl_dia, vector<int> & id_) =
      &nHamiltonian::Ehrenfest_energy_dia;

  CMATRIX (nHamiltonian::*expt_Ehrenfest_forces_adi_v1)
  (CMATRIX & ampl_adi, int lvl, int option) =
      &nHamiltonian::Ehrenfest_forces_adi;
  CMATRIX (nHamiltonian::*expt_Ehrenfest_forces_adi_v2)
  (CMATRIX & ampl_adi, int lvl) = &nHamiltonian::Ehrenfest_forces_adi;
  //  CMATRIX (nHamiltonian::*expt_Ehrenfest_forces_adi_v2)(CMATRIX& ampl_adi,
  //  vector<int>& id_) = &nHamiltonian::Ehrenfest_forces_adi;
  CMATRIX (nHamiltonian::*expt_Ehrenfest_forces_dia_v1)
  (CMATRIX & ampl_dia, int lvl, int option) =
      &nHamiltonian::Ehrenfest_forces_dia;
  CMATRIX (nHamiltonian::*expt_Ehrenfest_forces_dia_v2)
  (CMATRIX & ampl_dia, int lvl) = &nHamiltonian::Ehrenfest_forces_dia;
  //  CMATRIX (nHamiltonian::*expt_Ehrenfest_forces_dia_v2)(CMATRIX& ampl_dia,
  //  vector<int>& id_) = &nHamiltonian::Ehrenfest_forces_dia;

  vector<CMATRIX> (nHamiltonian::*expt_Ehrenfest_forces_tens_adi_v1)(
      CMATRIX & ampl_adi) = &nHamiltonian::Ehrenfest_forces_tens_adi;
  vector<CMATRIX> (nHamiltonian::*expt_Ehrenfest_forces_tens_adi_v2)(
      CMATRIX & ampl_adi, vector<int> & id_) =
      &nHamiltonian::Ehrenfest_forces_tens_adi;
  vector<CMATRIX> (nHamiltonian::*expt_Ehrenfest_forces_tens_dia_v1)(
      CMATRIX & ampl_dia) = &nHamiltonian::Ehrenfest_forces_tens_dia;
  vector<CMATRIX> (nHamiltonian::*expt_Ehrenfest_forces_tens_dia_v2)(
      CMATRIX & ampl_dia, vector<int> & id_) =
      &nHamiltonian::Ehrenfest_forces_tens_dia;

  void (nHamiltonian::*expt_add_ethd_dia_v1)(const MATRIX &q,
                                             const MATRIX &invM, int der_lvl) =
      &nHamiltonian::add_ethd_dia;
  void (nHamiltonian::*expt_add_ethd_adi_v1)(const MATRIX &q,
                                             const MATRIX &invM, int der_lvl) =
      &nHamiltonian::add_ethd_adi;

  void (nHamiltonian::*expt_add_ethd3_dia_v1)(
      const MATRIX &q, const MATRIX &invM, double alp, int der_lvl) =
      &nHamiltonian::add_ethd3_dia;
  void (nHamiltonian::*expt_add_ethd3_adi_v1)(
      const MATRIX &q, const MATRIX &invM, double alp, int der_lvl) =
      &nHamiltonian::add_ethd3_adi;
  void (nHamiltonian::*expt_add_ethd3_adi_v2)(
      const MATRIX &q, const MATRIX &p, const MATRIX &invM, double alp,
      double bet, int der_lvl) = &nHamiltonian::add_ethd3_adi;

  void (nHamiltonian::*expt_init_all_v1)(int der_lvl) = &nHamiltonian::init_all;
  void (nHamiltonian::*expt_init_all_v2)(int der_lvl, int lvl) =
      &nHamiltonian::init_all;

  void (nHamiltonian::*expt_copy_content_v1)(const nHamiltonian &src) =
      &nHamiltonian::copy_content;

  void (nHamiltonian::*expt_show_memory_status_v1)(vector<int> & id_) =
      &nHamiltonian::show_memory_status;
  ...
  class_<nHamiltonian>("nHamiltonian", init<int, int, int>())
      ...
      .def("set_basis_transform_by_ref",
           &nHamiltonian::set_basis_transform_by_ref)
      .def("set_basis_transform_by_val",
           &nHamiltonian::set_basis_transform_by_val)

      .def("init_time_overlap_adi", &nHamiltonian::init_time_overlap_adi)
      .def("set_time_overlap_adi_by_ref",
           &nHamiltonian::set_time_overlap_adi_by_ref)
      .def("set_time_overlap_adi_by_val",
           &nHamiltonian::set_time_overlap_adi_by_val)

      .def("init_time_overlap_dia", &nHamiltonian::init_time_overlap_dia)
      .def("set_time_overlap_dia_by_ref",
           &nHamiltonian::set_time_overlap_dia_by_ref)
      .def("set_time_overlap_dia_by_val",
           &nHamiltonian::set_time_overlap_dia_by_val)
      ...
      .def("set_cum_phase_corr_by_ref",
           &nHamiltonian::set_cum_phase_corr_by_ref)
      .def("set_cum_phase_corr_by_val",
           &nHamiltonian::set_cum_phase_corr_by_val)
  ...
  /*
    CMATRIX (*expt_compute_phase_corrections1_v1)(CMATRIX& S, double tol) =
    &compute_phase_corrections1; CMATRIX
    (*expt_compute_phase_corrections1_v2)(CMATRIX& U, CMATRIX& U_prev, double
    tol) = &compute_phase_corrections1;

    CMATRIX (*expt_compute_phase_corrections_v1)(CMATRIX& S) =
    &compute_phase_corrections; CMATRIX
    (*expt_compute_phase_corrections_v2)(CMATRIX& U, CMATRIX& U_prev) =
  ...
  */
  ...
  double (*expt_ETHD_energy_v1)(const MATRIX &q, const MATRIX &invM) =
      &ETHD_energy;
  MATRIX (*expt_ETHD_forces_v1)
  (const MATRIX &q, const MATRIX &invM) = &ETHD_forces;

  def("ETHD_energy", expt_ETHD_energy_v1);
  def("ETHD_forces", expt_ETHD_forces_v1);

  double (*expt_ETHD3_energy_v1)(const MATRIX &q, const MATRIX &invM,
                                 double alp) = &ETHD3_energy;
  double (*expt_ETHD3_energy_v2)(const MATRIX &q, const MATRIX &p,
                                 const MATRIX &invM, double alp, double bet) =
      &ETHD3_energy;
  MATRIX (*expt_ETHD3_forces_v1)
  (const MATRIX &q, const MATRIX &invM, double alp) = &ETHD3_forces;
  MATRIX (*expt_ETHD3_forces_v2)
  (const MATRIX &q, const MATRIX &p, const MATRIX &invM, double alp,
   double bet) = &ETHD3_forces;
  MATRIX (*expt_ETHD3_friction_v1)
  (const MATRIX &q, const MATRIX &p, const MATRIX &invM, double alp,
   double bet) = &ETHD3_friction;
